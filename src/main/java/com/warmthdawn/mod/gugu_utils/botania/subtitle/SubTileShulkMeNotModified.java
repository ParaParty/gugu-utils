...
public class SubTileShulkMeNotModified extends SubTileGenerating {
    public static final String TAG_CURSED_EARTH = GuGuUtils.MODID + ":cursedEarth";
    public static final String TAG_SPAWNER = GuGuUtils.MODID + ":spawner";
